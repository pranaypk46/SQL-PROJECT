...
-- find the top 3 state showing highest growth ratio
...
--find the bottom 3 state showing lowest sex ratio
...
-- find the top and bottom 3 states in literacy state
...
--find the total males and females
...
-- find the population in previous census
...
find the output top 3 districts from each state with highest literacy rate
